    ...
    <Form v-slot="{ meta }" @submit="save">
        ...
        <div class="card-body">
          <div class="mt-2">
            ...
            <div class="row" style="margin-top: 35px">
              ...
              <div class="col-sm">
                <Field class="form-control" name="position" :rules="isRequired" v-model="applicant.position" />
        ...
        <div class="card-body">
          ...
          <div class="mt-2">
            <div class="row">
              ...
              <div class="col-sm">
                <Field class="form-control" name="valid_to" type="date" v-model="applicant.valid_to" />
              </div>
            </div>
          </div>
          ...
          <div class="mt-2">
            <div class="row">
              ...
              <div class="col-sm">
                ...
                <InputText class="p-inputtext-sm" name="year_marriage" type="text" v-model="applicant.year_marriage" />
      ...
      <div v-if="nonformaleducation">
        ...
        <div class="card-footer text-muted">
          ...
          <Button class="p-button-sm" icon="pi pi-arrow-right" @click="(nonformaleducation = false), (computer = true)"
            :disabled="!(meta.valid && meta.dirty)" style="float: right;" />
        </div>
      </div>
      ...
      <div v-if="otherinfo">
        ...
        <div class="card-body">
          <div class="mt-2">
            ...
            <Field class="form-control" name="hospitalized" :rules="isRequired"
          ...
          <div class="mt-2">
            ...
            <Field class="form-control" name="reason_join" v-model="otherinformation.reason_join" :rules="isRequired" />
          ...
          <div class="mt-2">
            ...
            <Field class="form-control" name="reason_hire" v-model="otherinformation.reason_hire" :rules="isRequired" />
      ...
      <div v-if="attach">
        ...
        <div class="card-footer text-muted">
          ...
          <Button class="p-button-sm" type="submit" icon="pi pi-save" :disabled="!(meta.valid && meta.dirty)"
            style="float: right;" />
        </div>
      </div>
    </Form>
