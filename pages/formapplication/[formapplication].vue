    ...
    <Form v-slot="{ meta }" @submit="save">
      <div class="mx-5">
        <Card v-if="apply">
          ...
          <template #footer>
            ...
            <Button
              ...
              style="float: right"
              :disabled="!(applicant.JobId && applicant.photo)"
            />
          </template>
        </Card>
        <Card v-if="personal1">
                ...
                <div class="col-2">
                  <Field name="district_dom" v-model="applicant.district_dom">
                    <Dropdown
                      ...
                      optionLabel="nama"
                      @change="getDesaKel(applicant.district_dom.id, 'domicile')"
                    />
                  </Field>
                </div>
                <div class="col-2">
          ...
          <template #footer>
            ...
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-right"
              @click="(personal1 = false), (family = true)"
              :disabled="!meta.valid"
              style="float: right"
            />
          </template>
        ...
        <Card v-if="family">
          ...
          <template #footer>
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-left"
              @click="(family = false), (personal1 = true)"
            />
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-right"
        ...
        <Card v-if="formaleducation">
                    ...
                    <template #header>
                      <div class="flex px-3 pt-1">
                        ...
                        <p class="cursor-pointer ml-3">
                          <i
                            @click="cancelEdu(index, formaleducations)"
          ...
          <template #footer>
            ...
            <Button
              ...
              :disabled="formaleducations.length < 1"
              style="float: right"
            />
          </template>
        </Card>
        <Card v-if="nonformaleducation">
          ...
          <template #content>
            <Button
              @click="openDialogNonformal"
              icon="pi pi-plus"
              label="Tambah Pendidikan Nonformal"
            />
            <Dialog
              header="Pendidikan Non-Formal"
              v-model:visible="displayModalNonformal"
              :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
              :style="{ width: '80vw' }"
              :modal="true"
            >
                ...
                <div class="mt-2">
                  <div class="grid">
                    <label for="course" class="col-2">
                      <small>Nama Kursus / Training / Workshop</small
                  ...
                  <Card>
                    <template #header>
                      <div class="flex px-3 pt-1">
                        ...
                        <p class="cursor-pointer ml-3">
                          <i
                            @click="cancelEdu(index, nonformaleducations)"
                            class="pi pi-trash text-xs"
                          >
                          </i>
                        </p>
        ...
        <Card v-if="computer">
          ...
          <template #content>
            ...
            <Dialog
              ...
              v-model:visible="displayModalComputer"
              :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
              :style="{ width: '80vw' }"
              :modal="true"
            >
                ...
                <Column>
                  <template #body="{ index }">
                    <Button
                      ...
                      @click="cancelEdu(index, computersArr)"
                    />
                  </template>
                </Column>
              </DataTable>
          ...
          <template #footer>
            ...
            <Button
              ...
              :disabled="computersArr.length === 0"
              style="float: right"
            />
          </template>
        </Card>
        ...
        <Card v-if="employhistory">
          ...
          <template #content>
            ...
            <Dialog
              ...
              v-model:visible="dialogEmployHistory"
              :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
              :style="{ width: '80vw' }"
              :modal="true"
            >
                    ...
                    <div class="col">
                      ...
                      >
                        <InputText
                          ...
                          class="block w-full"
                        />
                        <small id="name_company-help" class="p-error block">{{
                          errorMessage
                        }}</small>
                      </Field>
                    </div>
                    ...
                    <div class="col">
                      ...
                      >
                        <InputText
                          ...
                          class="block w-full"
                        />
                        <small id="reason_leacing-help" class="p-error block">{{
                          errorMessage
                        }}</small>
                      </Field>
                    </div>
                  ...
                  <Card>
                    <template #header>
                      <div class="flex px-3 pt-1">
                        ...
                        <p class="cursor-pointer ml-3">
                          <i
                            @click="cancelEdu(index, employmenthistories)"
                            class="pi pi-trash text-xs"
                          >
                          </i>
                        </p>
          ...
          <template #footer>
            <Button
              ...
              class="p-button-sm"
              icon="pi pi-arrow-left"
              @click="(employhistory = false), (technicalSkill = true)"
            />
            <Button
              v-else
              class="p-button-sm"
        ...
        <Card v-if="otherinfo">
          ...
          <template #content>
            ...
            <div class="mt-2 mx-3">
              ...
              <Dropdown
                v-model="otherinformation.part_time_job"
                :options="hospitalized"
                optionLabel="val"
                class="w-full"
                optionValue="val"
          ...
          <template #footer>
            ...
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-right"
              @click="(otherinfo = false), (otherinfo2 = true)"
              :disabled="!(meta.valid && meta.dirty)"
              style="float: right"
            />
          </template>
        ...
        <Card v-if="otherinfo2">
          ...
          <template #content>
            ...
            <div class="mt-2 mx-3">
              ...
              <div>
                <Dropdown
                  v-model="otherinformation2.overtime"
                  :options="hospitalized"
                  optionLabel="val"
                  optionValue="val"
                  class="w-full"
            ...
            <div class="mt-2 mx-3">
              <label for="work_on_holiday">
                <small
                  >Apakah anda bersedia bekerja dihari libur? (hari Sabtu, Minggu, atau Hari Libur
                  Nasional)
                </small>
                <span style="color: red">*</span>
              </label>
              <div>
                <Dropdown
                  v-model="otherinformation2.work_on_holiday"
                  :options="hospitalized"
                  optionLabel="val"
                  optionValue="val"
                  class="w-full"
            ...
            <div class="mt-2 mx-3">
              <label for="out_town_duty">
                <small>Apakah anda bersedia dinas keluar kota ? </small>
                <span style="color: red">*</span>
              </label>
              <div>
                <Dropdown
                  v-model="otherinformation2.out_town_duty"
                  :options="hospitalized"
                  optionLabel="val"
                  optionValue="val"
                  class="w-full"
            ...
            <div class="mt-2 mx-3">
              <label for="shifting">
                <small
                  >Apakah anda bersedia bekerja secara shift? (posisi: Security dan IT Helpdesk)
                </small>
                <span style="color: red">*</span>
              </label>
              <div>
                <Dropdown
                  v-model="otherinformation2.shifting"
                  :options="hospitalized"
                  optionLabel="val"
                  optionValue="val"
                  class="w-full"
            ...
            <div class="mt-2 mx-3">
              <label for="giving_reference">
                <small
                  >Apakah Anda bersedia, jika Kami meminta referensi pada perusahaan Anda bekerja
                  sebelumnya
                </small>
                <span style="color: red">*</span>
              </label>
              <div>
                <Dropdown
                  v-model="otherinformation2.giving_reference"
                  :options="hospitalized"
                  optionLabel="val"
                  optionValue="val"
                  class="w-full"
          ...
          <template #footer>
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-left"
              @click="(otherinfo2 = false), (otherinfo = true)"
            />
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-right"
              @click="(otherinfo2 = false), (agreement = true)"
              style="float: right"
            />
          </template>
        </Card>
        <Card v-if="agreement">
          ...
          <template #footer>
            <Button
              class="p-button-sm"
              icon="pi pi-arrow-left"
              @click="(agreement = false), (otherinfo2 = true)"
            />
            <Button
              v-if="loading"
              class="p-button-sm"
      ...
      .post(config.API_BASE_URL + "applicants", {
        applicant: {
          ...
          subdistrict_dom: applicant.value.subdistrict_dom
            ? applicant.value.subdistrict_dom.nama
            : "",
