        ...
        <div class="card-body">
          ...
          <div class="mt-2">
            <label for="reason_join">
              <small
                >Sebutkan alasan anda ingin bergabung dengan PT Imani Prima? Why
          ...
          <div class="mt-2">
            <label for="plan">
              <small
                >Sebutkan rencana jangka pendek dan rencana jangka panjang anda?
          ...
          <div class="mt-2">
            <label for="respond_preasure">
              <small
                >Bagaimana tanggapan anda mengenai tekanan dalam pekerjaan? How
          ...
          <div class="mt-2">
            <label for="reason_leave_last_company">
              <small
                >Mengapa anda ingin keluar dari perusahaan terakhir ? Why do you
          ...
          <div class="mt-2">
            <label for="able_to_start">
              <small
                >Kapan anda dapat mulai bekerja ? When will you be able to start
                to work ?</small
              >
              <span style="color: red">*</span>
            </label>
          ...
          <div class="mt-2">
            <label for="relatives_in_ip">
              <small
                >Sebutkan nama kenalan anda di PT. Imani Prima dan hubungan anda
