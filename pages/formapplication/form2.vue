                        ...
                        <div class="mt-1" v-else>
                            ...
                            <div class="mt-5 mx-3">
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        <Field v-slot="{ field, errorMessage }" :rules="isRequired" name="name"
                                            v-model="data.name">
                            ...
                            <div class="mt-2 mx-3">
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        <Field v-slot="{ field, errorMessage }" :rules="isRequired" name="ktp"
                            ...
                            <div class="mt-2 mx-3">
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        <Field v-slot="{ field, errorMessage }" name="rekening"
                    ...
                    <template #footer>
                        <div class="flex justify-content-end">
                            <Button class="p-button-sm" icon="pi pi-arrow-right"
                                @click="(pribadi = false), (keluarga = true)" :disabled="!(meta.valid && meta.dirty)" />
                        </div>
                    </template>
                </Card>
                <Card v-if="keluarga">
                        ...
                        <div class="mt-5" v-if="data.applicant.marital_status === 'lajang'">
                            <div class="mt-2 mx-3">
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        <Field v-slot="{ field, errorMessage }" name="perkawinan"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mt-2 mx-3">
                                            <div class="grid">
                                                ...
                                                <div class="col">
                                                    <Field v-slot="{ field, errorMessage }" name="nama_ayah"
                                                        v-model="dataKeluargaLajang[0].name" :rules="isRequired">
                                                        <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }"
                                                            class="block w-full" />
                                                        <small id="email-help" class="p-error block">{{ errorMessage
                                                        }}</small>
                                                    </Field>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-2 mx-3">
                                            <div class="grid">
                                                ...
                                                <div class="col">
                                                    <Field name="pendidikan_ayah" v-model="dataKeluargaLajang[0].education"
                                                        :rules="isRequired">
                                                        <Dropdown class="w-full" v-model="dataKeluargaLajang[0].education"
                                                            :options="levels" optionValue="code" optionLabel="level_name"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mt-2 mx-3">
                                            <div class="grid">
                                                ...
                                                <div class="col">
                                                    <Field v-slot="{ field, errorMessage }" name="nama_ibu"
                                                        v-model="dataKeluargaLajang[1].name" :rules="isRequired">
                                                        <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }"
                                                            class="block w-full" />
                                                        <small id="email-help" class="p-error block">{{ errorMessage
                                                        }}</small>
                                        ...
                                        <div class="mt-2 mx-3">
                                            <div class="grid">
                                                ...
                                                <div class="col">
                                                    <Field name="pendidikan_ibu" v-model="dataKeluargaLajang[1].education"
                                                        :rules="isRequired">
                                                        <Dropdown class="w-full" v-model="dataKeluargaLajang[1].education"
                                                            :options="levels" optionValue="code" optionLabel="level_name"
                                                            placeholder="Select a Level" />
                                                    </Field>
                                                </div>
                        ...
                        <div class="mt-5" v-else-if="data.applicant.marital_status !== 'lajang'">
                            <div class="mt-2 mx-3">
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        <InputText name="perkawinan" v-model="data.applicant.marital_status"
                                            class="block w-full" disabled />
                                    </div>
                                </div>
                            </div>
