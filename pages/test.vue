        ...
        <Card v-if="pribadi">
            ...
            <div class="mt-1" v-else>
              ...
              <div class="mt-5 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <Field v-slot="{ field, errorMessage }" :rules="isRequired" name="name" v-model="data.name">
                      <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" disabled />
              ...
              <div class="mt-2 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <Field v-slot="{ field, errorMessage }" :rules="isRequired" name="position" v-model="job">
                      <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" disabled />
                      <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                    </Field>
                  </div>
              ...
              <div class="mt-2 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <Field v-slot="{ field, errorMessage }" :rules="isRequired" name="ktp" v-model="dataPribadi.ktp">
              ...
              <div class="mt-2 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <Field v-slot="{ field, errorMessage }" name="rekening" v-model="dataPribadi.rekening">
                      <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" />
                      <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                    </Field>
                  </div>
          ...
          <template #footer>
            <div class="flex justify-content-end">
              <Button class="p-button-sm" icon="pi pi-arrow-right" @click="(pribadi = false), (keluarga = true)"
        ...
        <Card v-if="keluarga">
            ...
            <div class="mt-5" v-if="data.applicant.marital_status === 'lajang'">
              <div class="mt-2 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <Field v-slot="{ field, errorMessage }" name="perkawinan" v-model="data.applicant.marital_status">
                      <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" disabled />
                      <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                    </Field>
                  </div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="nama_ayah" v-model="dataKeluargaLajang[0].name"
                            :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="tanggalLahir_ayah"
                            v-model="dataKeluargaLajang[0].date" :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full"
                              type="date" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field name="pendidikan_ayah" v-model="dataKeluargaLajang[0].education" :rules="isRequired">
                            <Dropdown class="w-full" v-model="dataKeluargaLajang[0].education" :options="levels"
                              optionValue="code" optionLabel="level_name" placeholder="Select a Level" />
                          </Field>
                        </div>
                      </div>
                    </div>
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="pekerjaan_ayah"
                            v-model="dataKeluargaLajang[0].occupation_company" :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                        </div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="nama_ibu" v-model="dataKeluargaLajang[1].name"
                            :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="tanggalLahir_ibu"
                            v-model="dataKeluargaLajang[1].date" :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full"
                              type="date" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field name="pendidikan_ibu" v-model="dataKeluargaLajang[1].education" :rules="isRequired">
                            <Dropdown class="w-full" v-model="dataKeluargaLajang[1].education" :options="levels"
                              optionValue="code" optionLabel="level_name" placeholder="Select a Level" />
                          </Field>
                        </div>
                      </div>
                    ...
                    <div class="mt-2 mx-3">
                      <div class="grid">
                        ...
                        <div class="col">
                          <Field v-slot="{ field, errorMessage }" name="pekerjaan_ibu"
                            v-model="dataKeluargaLajang[1].occupation_company" :rules="isRequired">
                            <InputText v-bind="field" :class="{ 'p-invalid': errorMessage }" class="block w-full" />
                            <small id="email-help" class="p-error block">{{ errorMessage }}</small>
                          </Field>
                        </div>
            ...
            <div class="mt-5" v-else-if="data.applicant.marital_status !== 'lajang'">
              <div class="mt-2 mx-3">
                <div class="grid">
                  ...
                  <div class="col">
                    <InputText name="perkawinan" v-model="data.applicant.marital_status" class="block w-full" disabled />
                  </div>
                </div>
              </div>
              <h3 class="text-center">Data Keluarga</h3>
          ...
          <template #footer>
            <div class="flex justify-content-between">
              <Button class="p-button-sm" icon="pi pi-arrow-left" @click="(pribadi = true), (keluarga = false)" />
              <Button class="p-button-sm" icon="pi pi-arrow-right" @click="(dokumen = true), (keluarga = false)" />
            </div>
          </template>
        </Card>
        <Card v-if="dokumen">
          ...
          <template #footer>
            <div class="flex justify-content-between">
              <Button class="p-button-sm" icon="pi pi-arrow-left" @click="(keluarga = true), (dokumen = false)" />
