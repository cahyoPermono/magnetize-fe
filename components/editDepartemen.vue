  ...
  >
    <Form class="mb-3" @submit="save">
      <div class="card p-3">
        <div class="">
          <label for="edit_nama"
            ><small>Nama</small><span style="color: red">*</span></label
          >
        ...
        <div class="mt-2">
          ...
          <Editor v-model="newDept.deskripsi" class="deskripsi-tambah" />
        </div>
      </div>
